...
const handler = async (m, { conn, text, usedPrefix, command }) => {
  try {
    if (!text.trim()) {
      return conn.reply(m.chat, `_*[ ⚠️ ] Agrega lo que quieres buscar en Youtube*_\n\n_Ejemplo:_\n.play Chica Paranormal.`, m);
    }
...
🕑 *𝙳𝚞𝚛𝚊𝚌𝚒𝚘́𝚗:* ${timestamp}
    ...
    await conn.sendMessage(m.chat, { image: thumb, caption: infoCancion }, { quoted: m });
