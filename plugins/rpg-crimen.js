  ...
  switch (randomOption) {
    case 0:
      ...
      conn.sendMessage(m.chat, {
        text: `⭐¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} 🍭 creds* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} 🍭 creds* a ${senderName}.`,
        contextInfo: {
    ...
    case 1:
      ...
      conn.reply(m.chat, `🤣 No fuiste cuidadoso y te atraparon mientras cometias tu cirme, se restaron *-${amountSubtracted} 🪙 Creds* a ${senderName}.`, m)
      break
    ...
    case 2:
      ...
      conn.sendMessage(m.chat, {
        text: `⭐ Lograste cometer tu crimen con exito, pero te descubrieron y solo lograste tomar *${smallAmountTaken} 🪙 Creds* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} 🪙 Creds* a ${senderName}.`,
        contextInfo: {
          mentionedJid: [randomUserId],
        }
      }, { quoted: m })
